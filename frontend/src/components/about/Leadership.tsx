...
export default function Leadership() {
  ...
  const [activeProfile, setActiveProfile] =
    useState<StrapiItem<LeadershipMember> | null>(null);
    ...
    <section className="leadership-section section" id="leadership">
      <div className="container">
        <div className="section-header">
          <h2>Leadership</h2>
          <p>
            Meet the dedicated leaders driving healthcare transformation in
            Sierra Leone
          </p>
        </div>
            ...
            <div className="featured-leader-card">
              ...
              <div className="featured-leader-info">
                ...
                {minister.credentials && (
                  <span className="leader-credentials">
                    {minister.credentials}
                  </span>
                )}
                <p>{minister.bio}</p>
